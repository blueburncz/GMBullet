	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	btStridingMeshInterface* meshInterface = (btStridingMeshInterface*)YYGetPtr(arg, 0);
	bool useQuantizedAabbCompression = YYGetBool(arg, 1);
	btVector3& bvhAabbMin = *(btVector3*)YYGetPtr(arg, 2);
	btVector3& bvhAabbMax = *(btVector3*)YYGetPtr(arg, 3);
	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	auto bvhTriangleMeshShape = (btBvhTriangleMeshShape*)YYGetPtr(arg, 0);
	auto callback = (btTriangleCallback*)YYGetPtr(arg, 1);
	btVector3& boxSource = *(btVector3*)YYGetPtr(arg, 2);
	btVector3& boxTarget = *(btVector3*)YYGetPtr(arg, 3);
	btVector3& boxMin = *(btVector3*)YYGetPtr(arg, 4);
	btVector3& boxMax = *(btVector3*)YYGetPtr(arg, 5);
	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	auto bvhTriangleMeshShape = (btBvhTriangleMeshShape*)YYGetPtr(arg, 0);
	auto callback = (btTriangleCallback*)YYGetPtr(arg, 1);
	btVector3& boxMin = *(btVector3*)YYGetPtr(arg, 2);
	btVector3& boxMax = *(btVector3*)YYGetPtr(arg, 3);
...
{
	auto bvhTriangleMeshShape = (btBvhTriangleMeshShape*)YYGetPtr(arg, 0);
	btVector3& boxMin = *(btVector3*)YYGetPtr(arg, 1);
	btVector3& boxMax = *(btVector3*)YYGetPtr(arg, 2);
	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	...
	if (argc > 2)
	{
		btVector3& localScaling = *(btVector3*)YYGetPtr(arg, 2);
