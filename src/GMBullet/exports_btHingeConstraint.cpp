	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	...
	btVector3& axisInA = *(btVector3*)YYGetPtr(arg, 2);
	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	...
	btVector3& axisInA = *(btVector3*)YYGetPtr(arg, 4);
	btVector3& axisInB = *(btVector3*)YYGetPtr(arg, 5);
...
{
	btRigidBody& rigidBodyA = *(btRigidBody*)YYGetPtr(arg, 0);
	btTransform& rigidBodyAFrame = *(btTransform*)YYGetPtr(arg, 1);
	...
	RValue& result, CInstance* self, CInstance* other, int argc, RValue* arg)
{
	btRigidBody& rigidBodyA = *(btRigidBody*)YYGetPtr(arg, 0);
	btRigidBody& rigidBodyB = *(btRigidBody*)YYGetPtr(arg, 1);
	btTransform& rigidBodyAFrame = *(btTransform*)YYGetPtr(arg, 2);
	btTransform& rigidBodyBFrame = *(btTransform*)YYGetPtr(arg, 3);
...
{
	auto hingeConstraint = (btHingeConstraint*)YYGetPtr(arg, 0);
	btQuaternion& qAinB = *(btQuaternion*)YYGetPtr(arg, 1);
...
{
	auto hingeConstraint = (btHingeConstraint*)YYGetPtr(arg, 0);
	btVector3& axisInA = *(btVector3*)YYGetPtr(arg, 1);
