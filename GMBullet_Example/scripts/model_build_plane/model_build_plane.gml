/// @description  model_build_plane(x1, y1, z1, x2, y2, z2, hrepeat, vrepeat);
/// @param x1
/// @param  y1
/// @param  z1
/// @param  x2
...
/// @param  hrepeat
/// @param  vrepeat
function model_build_plane(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	var x1 = argument0,
	    y1 = argument1,
	    z1 = argument2,
	    x2 = argument3,
